...
public class SquareTester {
    ...
    public static void main(String args[]){
        ...
        System.out.println("xLocal[0] = " + test.xLocal[0] + ", xLocal[1] =  " + test.xLocal[1] + ", xLocal[2] = " + test.xLocal[2] + ", xLocal[3] =  " + test.xLocal[3]);
        System.out.println("yLocal[0] = " + test.yLocal[0] + ", yLocal[1] =  " + test.yLocal[1] + ", yLocal[2] = " + test.yLocal[2] + ", yLocal[3] =  " + test.yLocal[3]);
        System.out.println("theta : " + test.theta);
        System.out.println("xc = " + test.xc + ", yc = " + test.yc);
        int[] testX = test.getX();
        int[] testY = test.getY();
        System.out.println("After the function call, " + "getX[0] = " + testX[0] + ", getX[1] =  " + testX[1] + ", getX[2] = " + testX[2] + ", getX[3] =  " + testX[3]);
        System.out.println("After the function call, " + "getY[0] = " + testY[0] + ", getY[1] =  " + testY[1] + ", getY[2] = " + testY[2] + ", getY[3] =  " + testY[3]);
        System.out.println("--------------------------------------------------------------");
    }
}
