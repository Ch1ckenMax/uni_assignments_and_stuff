...
public class BigTwoGUI implements CardGameUI{
    ...
    public void enable(){
        ...
        for(int i = 0; i < game.getNumOfPlayers(); i++){
            bigTwoPanels.get(i).activateListeners();
        }
    }
    ...
    public BigTwoGUI(BigTwo game){
        ...
        restart.setBackground(TITLE_COLOR);
        restart.setForeground(TEXT_COLOR_WHITE);
    ...
    class BigTwoPanel extends JPanel implements MouseListener{
        ...
        public void repaintCards(){
            ...
            else if(activePlayer == -1 || activePlayer == this.playerIdx){ //Show all cards when: active player = -1 (the game ended), or this player is active player
                int horizontalOffset = 0;
                ...
                if(game.endOfGame()){ //End of the game.
                    ...
                    for(int i = 0; i < game.getNumOfPlayers(); i++){
                        ...
                        if(player.getNumOfCards() == 0)
                            printMsg(player.getName()+" wins the game.");
                        else
    ...
    /**
     * Listener for handling button-click events for restart button.
     */
    class RestartMenuItemListener implements ActionListener{
        /**
         * Handles button-click events for restart. Restarts the game.
         */
        public void actionPerformed(ActionEvent e){
            reset();
