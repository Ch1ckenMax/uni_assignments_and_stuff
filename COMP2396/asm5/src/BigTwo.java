...
public class BigTwo implements CardGame{
    ...
    public BigTwo(){
        ...
        //BigTwoUI
        gui = new BigTwoGUI(this); //Considered putting client to constructor parameter but the reference is pass by val and it would be null even after finishing next line
        client = new BigTwoClient(this, gui);

        gui.printMsg("Please connect to a server to proceed.");
    }
    ...
    /**
     * Getter method for retrieving the client
     * 
     * @return The client
     */
     ...
     * Switches the current player to the next player by modifying currentPlayerIdx. Does nothing otherwise.
     * 
     * @param playerIdx The index of the player who made this move
     * @param cardIdx The list of cards in the player's cards list chosen to make the move
     */
