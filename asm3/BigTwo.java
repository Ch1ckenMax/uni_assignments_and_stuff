...
public class BigTwo implements CardGame{
    ...
    public void start(Deck deck){
        ...
        while(!endOfGame()){
            ...
            int currentRoundPlayerIdx = currentPlayerIdx;
            ui.repaint();
            while(currentPlayerIdx != (currentRoundPlayerIdx + 1) % numOfPlayers){
        ...
        for(int i = 0; i < numOfPlayers; i++){
            ...
            if(player.getNumOfCards() == 0)
                ...
                System.out.println(player.getName()+" has "+player.getNumOfCards()+" cards in hand.");
        }
    }
